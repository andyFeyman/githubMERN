...
const Repo = ({ repo }) => {
	const formattedDate = formatDate(repo.created_at); //turn 2018-05-07T13:27:00Z to  July 30th, 2011
    ...
    rounded-full -start-3 ring-8 ring-white'
     ...
     text-gray-400'
			...
			{PROGRAMMING_LANGUAGES[repo.language] ? (
				<img src={PROGRAMMING_LANGUAGES[repo.language]} alt='Programming language icon' className='h-6' />
			) : null}
		</li>
	);
};
